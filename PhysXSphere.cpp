/* CPhysXSphere type actor - rigid body, Janusz Goldasz */
#include "PhysXSphere.h"

// create sphere
osg::Geode* CPhysXSphere::init(NxScene* scene, float radius, osg::Vec3f position)
{
...
osg::Group* distributeSpheres(NxScene* gScene, float terrainSize, int n)
{
	...
	for(int i=0; i<n; i++)
	{
		...
		_group->addChild(new CPhysXSphere(gScene, r, _position));
	}
	return _group;
}
