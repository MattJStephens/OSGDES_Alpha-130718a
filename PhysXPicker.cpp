/* CPhysXPicker class implementation - Janusz Goldasz */
#include "PhysXPicker.h"
#include "PhysXSphere.h"
//#include "RayCastReport.h"

void CPhysXPicker::shoot(const osgGA::GUIEventAdapter& ea, osgViewer::Viewer* viewer)
{
...
void CPhysXPicker::pick(const osgGA::GUIEventAdapter& ea, osgViewer::Viewer* viewer)
{
...
void CPhysXPicker::trySoftBodyHit(NxVec3 gDir)
{
	// try soft bodies
	NxVec3 hit;
	NxU32 vertexId;
...
void CPhysXPicker::tryRigidBodyHit(NxShape* shape, NxVec3 gDir, NxRaycastHit hit)
{
...
NxRay CPhysXPicker::convertToCameraDir(osg::Vec3f eye, osg::Vec3f center)
{
